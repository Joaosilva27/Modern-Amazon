          ...
          {products.map((product) => (
            ...
            >
              ...
              <div className="p-4 space-y-2">
                <h3 className="text-[#4d5c55] font-semibold line-clamp-2">
                  {product.title}
                </h3>
                ...
                <button className="w-full py-2 text-sm font-medium text-[#4d5c55] bg-[#f0f7ed] hover:bg-[#cbddc6] rounded-lg transition-colors">
                  View Product
                </button>
              </div>
            </div>
